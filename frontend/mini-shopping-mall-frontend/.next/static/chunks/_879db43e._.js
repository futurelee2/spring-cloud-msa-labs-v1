...
function ProductDetailPage(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailPage.useEffect": ()=>{
            const getParams = {
                "ProductDetailPage.useEffect.getParams": async ()=>{
                    const resolvedParams = await params;
                    setProductId(resolvedParams.id);
                }
            }["ProductDetailPage.useEffect.getParams"];
            getParams();
        }
    }["ProductDetailPage.useEffect"], [
        params
        ...
        "ProductDetailPage.useEffect": ()=>{
            ...
            const fetchProduct = {
                "ProductDetailPage.useEffect.fetchProduct": async ()=>{
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productApi"].getProduct(Number(productId));
                        setProduct(data);
                    } catch (err) {
    ...
    const handleOrder = ()=>{
        if (product) {
            router.push("/order?productId=".concat(product.id, "&quantity=").concat(quantity));
        }
    };
...
_s(ProductDetailPage, "Z5tMaDlt0p2xF9orBhINBMVsK+A=", false, function() {
    return [
...
//# sourceMappingURL=_879db43e._.js.map