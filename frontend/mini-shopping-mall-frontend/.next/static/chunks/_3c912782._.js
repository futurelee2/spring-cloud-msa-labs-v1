...
const userApi = {
    getUser: (id)=>apiRequest("/users/".concat(id)),
...
function OrderPage() {
    ...
    const { user, isAuthenticated, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrderPage.useEffect": ()=>{
            ...
            const fetchProduct = {
                "OrderPage.useEffect.fetchProduct": async ()=>{
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productApi"].getProduct(productId);
                        setProduct(data);
                    } catch (err) {
            ...
            }["OrderPage.useEffect.fetchProduct"];
            if (productId) {
                fetchProduct();
            }
        }
    ...
    const handleSubmitOrder = async ()=>{
        ...
        setError(null);
        try {
            const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderApi"].createOrder({
                userId: user.id,
                productId: product.id,
                quantity
            });
            router.push("/order/success?orderId=".concat(order.id));
        } catch (err) {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    children: loading ? '주문 처리 중...' : '주문 확정'
                                }, void 0, false, {
                                    fileName: "[project]/src/app/order/page.tsx",
                                    lineNumber: 124,
                                    columnNumber: 13
...
_s(OrderPage, "kqgMihFQYrd77XD6F5SMt7a1b7o=", false, function() {
    return [
...
//# sourceMappingURL=_3c912782._.js.map